/**
 * Projects Page Content - Portfolio
        ...
        {projectsConfig.items.map((project, index) => (
          <div key={index}>
            ...
            <a
              ...
              className="hidden md:flex relative flex-col items-stretch duration-300 ease-out p-3 group h-100 rounded-2xl"
            >
              {/* Border layer 1 (back) - animated on hover */}
              ...
              {/* Border layer 2 (front) - animated on hover */}
              ...
              <span className="relative z-30 block duration-300 ease-out group-hover:-translate-x-1 group-hover:-translate-y-1">
                ...
                <span className="block w-full px-1 mt-5 mb-1 sm:mt-3">
                  ...
                  {/* Tech Stack badges - same style as skill tags in About */}
                  {project.techStack && (
            ...
            <div className="md:hidden relative flex flex-col items-stretch p-7 rounded-2xl">
              ...
              <div className="relative z-20">
                ...
                <div className="w-full px-1 mt-5 mb-1">
                  ...
                  {/* Tech Stack badges - mobile version */}
                  {project.techStack && (
