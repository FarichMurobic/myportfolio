  ...
  return (
    <section className="relative z-20 max-w-4xl mx-auto mt-20 md:mt-32 mb-12 px-7 lg:px-0">
      ...
      <div className="z-50 grid items-stretch w-full grid-cols-1 my-8 gap-7 sm:gap-5 sm:grid-cols-2 lg:grid-cols-2">
        {certificationsConfig.items.map((certifications, index) => (
          <a
            key={index}
            href={certifications.href}
            target="_blank"
            className="relative flex flex-col items-stretch duration-300 ease-out p-8 sm:p-5 group h-100 rounded-2xl"
          >
