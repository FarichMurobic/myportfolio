        ...
        <div className="w-[360px] ml-8">
          ...
          <div className="py-[30px]">
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              <a href={aboutConfig.connect.links.github.url} target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 underline hover:text-indigo-800 transition">
                GitHub
              </a>
              <a href={aboutConfig.connect.links.linkedin.url} target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 underline hover:text-indigo-800 transition">
                LinkedIn
              </a>
              <a href={aboutConfig.connect.links.instagram.url} target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 underline hover:text-indigo-800 transition">
                Instagram
              </a>
              <a href={aboutConfig.connect.links.email.url} className="text-indigo-600 dark:text-indigo-400 underline hover:text-indigo-800 transition">
                Email
              </a>
            </div>
          </div>
